const PRODUCTS = [
  {
    ...
    targetWeeds: [
        ...
        "Annual Foxtail (Setaria spp.)",
        "Barnyardgrass (Echinochloa crus-galli)",
        "Broadleaf Signalgrass (Urochloa platyphylla)",
        "Browntop Millet / Panicum (Urochloa ramosa)",
  ...
  },
  {
    ...
    targetWeeds: [
        ...
        { name: "Browntop Millet / Panicum (Urochloa ramosa)", rateRequired: "Medium" },
        ...
        { name: "Dollarweed/Pennywort (Hydrocotyle umbellata)", rateRequired: "Medium" },
        { name: "Doveweed (Murdannia nudiflora)",             rateRequired: "High"   },
        { name: "Fleabane (Erigeron spp.)",                   rateRequired: "Medium" },
        ...
        { name: "Lespedeza",                                  rateRequired: "High"   },
        { name: "Prostrate Spurge (Euphorbia prostrata)",     rateRequired: "High"   },
        { name: "Sandbur (Cenchrus spp.)",                    rateRequired: "Medium" },
        ...
        { name: "Woodsorrel (Oxalis spp.)",                   rateRequired: "Medium" },
    ],
    containerSizes: [
...

  {
    ...
    targetWeeds: [
        "Annual Bluegrass (Poa annua)",
        "Annual Sedges (Cyperus compressus)",
        "Common Chickweed (Stellaria media)",
        "Crowfootgrass (Dactyloctenium aegyptium)",
        "Dallisgrass (Paspalum dilatatum)",
        "Dandelion (Taraxacum officinale)",
        "Dollarweed/Pennywort (Hydrocotyle umbellata)",
        "False Green Kyllinga (Kyllinga gracillima)",
        "Fragrant Kyllinga (Kyllinga odorata)",
        "Globe Sedge (Cyperus echinatus/globulosus)",
...

  {
    ...
    targetWeeds: [  
      { name: "Annual Fleabane (Erigeron annuus)",            rateRequired: "Low" },  
      { name: "Annual Sowthistle (Sonchus oleraceus)",        rateRequired: "Medium" },  
      { name: "Bahiagrass (Paspalum notatum)",                rateRequired: "Medium" }, // selective removal in Bermudagrass only; 3–9 oz/acre  
      { name: "Bitter Sneezeweed (Helenium amarum)",          rateRequired: "Medium" },  
      { name: "Bittercress (Cardamine spp.)",                 rateRequired: "Low" },  
      { name: "Black Medic (Medicago lupulina)",              rateRequired: "Low" },  
      { name: "Black Nightshade (Solanum nigrum)",            rateRequired: "High" },  
      { name: "Blue Mustard (Chorispora tenella)",            rateRequired: "Low" },  
      { name: "Bracken Fern (Pteridium aquilinum)",           rateRequired: "High" },  
      { name: "Bracted Plantain (Plantago aristata)",         rateRequired: "Medium" },  
      { name: "Brazil Pusley (Richardia brasiliensis)",       rateRequired: "High" },  
      { name: "Bristly Mallow (Modiola caroliniana)",         rateRequired: "Low" },  
      { name: "Broadleaf Dock (Rumex obtusifolius)",          rateRequired: "Medium" },  
      { name: "Buckhorn Plantain (Plantago lanceolata)",      rateRequired: "High" },  
      { name: "Buffalobur (Solanum rostratum)",               rateRequired: "Medium" },  
      { name: "Bull Thistle (Cirsium vulgare)",               rateRequired: "Medium" },  
      { name: "Burclover (Medicago polymorpha)",              rateRequired: "Medium" },  
      { name: "Burcucumber (Sicyos angulatus)",               rateRequired: "Medium" },  
      { name: "Buttercup (Ranunculus spp.)",                  rateRequired: "Low" },  
      { name: "Canada Thistle (Cirsium arvense)",             rateRequired: "High" }, // repeat application may be required  
      { name: "Carpetweed (Mollugo verticillata)",            rateRequired: "Low" },  
      { name: "Carolina Geranium (Geranium carolinianum)",    rateRequired: "Low" },  
      { name: "Catchweed Bedstraw (Galium aparine)",          rateRequired: "Low" },  
      { name: "Chicory (Cichorium intybus)",                  rateRequired: "Low" },  
      { name: "Cocklebur (Xanthium strumarium)",              rateRequired: "Medium" },  
      { name: "Common Burdock (Arctium minus)",               rateRequired: "Medium" },  
      { name: "Common Chickweed (Stellaria media)",           rateRequired: "Low" },  
      { name: "Common Evening Primrose (Oenothera biennis)",  rateRequired: "Medium" },  
      { name: "Common Groundsel (Senecio vulgaris)",          rateRequired: "High" },  
      { name: "Common Lambsquarters (Chenopodium album)",     rateRequired: "Medium" },  
      { name: "Common Mallow (Malva neglecta)",               rateRequired: "Medium" },  
      ...
      { name: "Common Sunflower (Helianthus annuus)",         rateRequired: "High" },  
      { name: "Common Wormwood (Artemisia absinthium)",       rateRequired: "High" },  
      { name: "Common Yarrow (Achillea millefolium)",         rateRequired: "Medium" },  
      { name: "Corn Chamomile (Anthemis arvensis)",           rateRequired: "Low" },  
      { name: "Corn Cockle (Agrostemma githago)",             rateRequired: "Low" },  
      { name: "Cow Cockle (Vaccaria hispanica)",              rateRequired: "Low" },  
      { name: "Creeping Beggarweed (Desmodium incanum)",      rateRequired: "Low" },  
      { name: "Creeping Woodsorrel (Oxalis corniculata)",     rateRequired: "High" }, // repeat application may be required  
      { name: "Crown Vetch (Securigera varia)",               rateRequired: "Medium" },  
      { name: "Curly Dock (Rumex crispus)",                   rateRequired: "Medium" },  
      { name: "Cutleaf Evening Primrose (Oenothera laciniata)", rateRequired: "Medium" },  
      { name: "Dandelion (Taraxacum officinale)",             rateRequired: "Low" },  
      { name: "Dogfennel (Eupatorium capillifolium)",         rateRequired: "High" }, // listed at both 4–6 and 6–12 oz/acre  
      { name: "Dwarf Mallow (Malva rotundifolia)",            rateRequired: "Low" },  
      { name: "English Daisy (Bellis perennis)",              rateRequired: "Medium" },  
      { name: "Field Bindweed (Convolvulus arvensis)",        rateRequired: "High" },  
      { name: "Field Chickweed (Cerastium arvense)",          rateRequired: "Medium" },  
      { name: "Field Pennycress (Thlaspi arvense)",           rateRequired: "Low" },  
      { name: "Florida Beggarweed (Desmodium tortuosum)",     rateRequired: "Low" },  
      { name: "Florida Betony (Stachys floridana)",           rateRequired: "Medium" },  
      { name: "Foxtail (Setaria spp.)",                       rateRequired: "High" },  
      { name: "Giant Ragweed (Ambrosia trifida)",             rateRequired: "Medium" },  
      { name: "Goldenrod (Solidago spp.)",                    rateRequired: "Medium" },  
      { name: "Gromwell (Lithospermum spp.)",                 rateRequired: "Medium" },  
      { name: "Ground Ivy (Glechoma hederacea)",              rateRequired: "Medium" }, // repeat application may be required  
      { name: "Hawkweed (Hieracium spp.)",                    rateRequired: "Medium" },  
      { name: "Hemp Sesbania (Sesbania herbacea)",            rateRequired: "Medium" },  
      { name: "Henbit (Lamium amplexicaule)",                 rateRequired: "Medium" },  
      { name: "Hoary Cress (Lepidium draba)",                 rateRequired: "High" },  
      { name: "Horsenettle (Solanum carolinense)",            rateRequired: "High" },  
      { name: "Horseweed (Conyza canadensis)",                 rateRequired: "High" },  
      { name: "Ironweed (Vernonia spp.)",                     rateRequired: "High" },  
      { name: "Jerusalem Artichoke (Helianthus tuberosus)",   rateRequired: "High" },  
      { name: "Jimsonweed (Datura stramonium)",               rateRequired: "Medium" },  
      { name: "Knotweed (Polygonum spp.)",                    rateRequired: "Medium" },  
      { name: "Kochia (Bassia scoparia)",                     rateRequired: "High" },  
      { name: "Lawn Burweed (Soliva sessilis)",               rateRequired: "Medium" },  
      { name: "Leafy Spurge (Euphorbia esula)",               rateRequired: "High" },  
      { name: "Lespedeza (Lespedeza spp.)",                   rateRequired: "Medium" },  
      { name: "Louisiana Wormwood (Artemisia ludoviciana)",   rateRequired: "High" },  
      { name: "Mayweed (Anthemis cotula)",                    rateRequired: "Medium" },  
      { name: "Milk Thistle (Silybum marianum)",              rateRequired: "Medium" },  
      { name: "Milkweed (Asclepias spp.)",                    rateRequired: "Medium" },  
      { name: "Miners Lettuce (Claytonia perfoliata)",        rateRequired: "Medium" },  
      { name: "Morningglory (Ipomoea spp.)",                  rateRequired: "Medium" },  
      { name: "Mouseear Chickweed (Cerastium fontanum)",      rateRequired: "Medium" },  
      { name: "Musk Thistle (Carduus nutans)",                rateRequired: "Medium" },  
      { name: "Parsley-Piert (Aphanes arvensis)",             rateRequired: "Low" },  
      { name: "Pennsylvania Smartweed (Persicaria pensylvanica)", rateRequired: "High" }, // listed at both 4–6 and 6–12 oz/acre  
      { name: "Perennial Sowthistle (Sonchus arvensis)",      rateRequired: "High" },  
      { name: "Pigweed (Amaranthus spp.)",                    rateRequired: "Medium" },  
      { name: "Plantain (Plantago spp.)",                     rateRequired: "Medium" },  
      { name: "Pokeweed (Phytolacca americana)",              rateRequired: "High" },  
      { name: "Poorjoe (Diodia teres)",                       rateRequired: "High" },  
      { name: "Prickly Sida (Sida spinosa)",                  rateRequired: "Medium" },  
      { name: "Prostrate Knotweed (Polygonum aviculare)",     rateRequired: "High" },  
      { name: "Prostrate Spurge (Euphorbia prostrata)",       rateRequired: "Low" },  
      { name: "Purple Vetch (Vicia benghalensis)",            rateRequired: "Medium" },  
      { name: "Redroot Pigweed (Amaranthus retroflexus)",     rateRequired: "Medium" },  
      { name: "Redstem Filaree (Erodium cicutarium)",         rateRequired: "Low" },  
      { name: "Russian Thistle (Salsola tragus)",             rateRequired: "High" },  
      { name: "Ryegrass (Lolium spp.)",                       rateRequired: "Medium" }, // listed at both 3 oz and 4–6 oz/acre  
      { name: "Sheep Sorrel (Rumex acetosella)",              rateRequired: "Medium" },  
      { name: "Sicklepod (Senna obtusifolia)",                rateRequired: "High" },  
      { name: "Silverleaf Nightshade (Solanum elaeagnifolium)", rateRequired: "Medium" },  
      { name: "Slender Aster (Symphyotrichum subulatum)",     rateRequired: "Medium" },  
      { name: "Smallseed Falseflax (Camelina microcarpa)",    rateRequired: "Medium" },  
      { name: "Smooth Pigweed (Amaranthus hybridus)",         rateRequired: "Medium" },  
      { name: "Smoothweed Bedstraw (Galium mollugo)",         rateRequired: "Low" },  
      { name: "Southern Sida (Sida acuta)",                   rateRequired: "High" },  
      { name: "Spiny Amaranth (Amaranthus spinosus)",         rateRequired: "Medium" },  
      { name: "Spiny Aster (Chloracantha spinosa)",           rateRequired: "Medium" },  
      { name: "Spotted Knapweed (Centaurea stoebe)",          rateRequired: "Medium" },  
      { name: "Stinging Nettle (Urtica dioica)",              rateRequired: "Medium" },  
      { name: "Sweet Clover (Melilotus spp.)",                rateRequired: "Medium" },  
      { name: "Tansy Mustard (Descurainia pinnata)",          rateRequired: "Medium" },  
      { name: "Teasel (Dipsacus spp.)",                       rateRequired: "Medium" },  
      { name: "Treacle Mustard (Erysimum cheiranthoides)",    rateRequired: "Medium" },  
      { name: "Tropic Croton (Croton glandulosus)",           rateRequired: "Medium" },  
      { name: "Tropical Soda Apple (Solanum viarum)",         rateRequired: "High" },  
      { name: "Trumpetcreeper (Campsis radicans)",            rateRequired: "High" },  
      { name: "Tumble Mustard (Sisymbrium altissimum)",       rateRequired: "Medium" },  
      { name: "Velvetleaf (Abutilon theophrasti)",            rateRequired: "Medium" },  
      { name: "Virginia Buttonweed (Diodia virginiana)",      rateRequired: "High" }, // repeat application may be required  
      { name: "Virginia Pepperweed (Lepidium virginicum)",    rateRequired: "Low" },  
      { name: "Waterhemlock (Cicuta spp.)",                   rateRequired: "Medium" },  
      { name: "Waterhemp (Amaranthus tuberculatus)",          rateRequired: "High" },  
      { name: "White Clover (Trifolium repens)",              rateRequired: "Low" },  
      { name: "Wild Buckwheat (Fallopia convolvulus)",        rateRequired: "Low" },  
      { name: "Wild Carrot (Daucus carota)",                  rateRequired: "Low" },  
      { name: "Wild Celery (Apium graveolens)",               rateRequired: "Medium" },  
      { name: "Wild Garlic (Allium vineale)",                 rateRequired: "Medium" },  
      { name: "Wild Lettuce (Lactuca spp.)",                  rateRequired: "Medium" },  
      { name: "Wild Mustard (Sinapis arvensis)",              rateRequired: "High" },  
      { name: "Wild Onion (Allium canadense)",                rateRequired: "Medium" },  
      { name: "Wild Radish (Raphanus raphanistrum)",          rateRequired: "Medium" },  
      { name: "Woodsorrel (Oxalis spp.)",                     rateRequired: "Medium" },  
      { name: "Yankeeweed (Eupatorium compositifolium)",      rateRequired: "High" }  
    ],
